...
namespace SingleBoostr
{
    class SteamWeb : WebClient
    {
        ...
        protected override WebResponse GetWebResponse(WebRequest request, IAsyncResult result)
        {
            ...
            {
                _log.Write(Log.LogLevel.Error, $"Erreur sur GetWebResponse avec: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<string> Request(string url)
        {
            ...
            {
                _log.Write(Log.LogLevel.Error, $"Erreur lors du téléchargement de la chaîne à '{url}' avec erreur: {ex.Message}");
                return string.Empty;
            }
        }
        ...
        public async Task<byte[]> RequestData(string url)
        {
            ...
            {
                _log.Write(Log.LogLevel.Error, $"Erreur lors du téléchargement des données à '{url}' avec erreur: {ex.Message}");
                return null;
            }
        }
