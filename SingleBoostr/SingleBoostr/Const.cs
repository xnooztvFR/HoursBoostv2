...
namespace SingleBoostr
{
    class Const
    {
        ...
        public const string GITHUB_PROFILE_URL = "https://github.com/xnooztvFR";
        public const string GITHUB_REPO_URL = "https://github.com/xnooztvFR/HoursBoostv2";
        public const string STEAM_GROUP_URL = "http://steamcommunity.com/groups/SingleBoostr";
        ...
        public static string REPO_RELEASE_URL = "https://github.com/xnooztvFR/HoursBoostv2/releases/latest";
        public static string VERSION_FILE_URL = "http://xnooztvf.livehost.fr/version.json";
        public const string CARD_PRICE_URL = "https://api.enhancedsteam.com/market_data/average_card_prices/?cur=eur&appids=";
        public const string CHAT_BUBBLE_URL = "http://xnooztvf.livehost.fr/Bubbles.json";
        public const string DONATION_URL = "http://xnooztvf.livehost.fr/donation.json";
